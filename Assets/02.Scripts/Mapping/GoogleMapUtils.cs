...
namespace FoodyGo.Mapping
{
    ...
    public class GoogleMapUtils
    {
        ...
        static private double UNITY_UNIT = 100.0;

        static private double PIXELS = 640.0;

        static private double UNITY_UNITS_PER_PIXEL = UNITY_UNIT / PIXELS;
        ...
        public static float LatToUnityY(double lat, double centerLat, int zoom)
        {
            ...
            double deltaPx = centerPx - px; // Y 좌표는 위로 갈수록 작아지므로 반전
